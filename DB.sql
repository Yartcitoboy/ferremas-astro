...
INSERT INTO producto (nombre, descripcion, precio, stock, marca, modelo, codigo, id_categoria)
VALUES ('Martillo de carpintero', 'Martillo con mango de madera y cabeza de acero.', 8.50, 100, 'Stanley', 'STHT51304', 'HM001', 1);

INSERT INTO producto (nombre, descripcion, precio, stock, marca, modelo, codigo, id_categoria)
VALUES ('Destornillador plano', 'Destornillador con punta plana y mango ergonómico.', 3.25, 150, 'Truper', 'DES-3', 'HM002', 1);

-- Herramientas eléctricas
INSERT INTO producto (nombre, descripcion, precio, stock, marca, modelo, codigo, id_categoria)
VALUES ('Taladro eléctrico', 'Taladro de 500W con velocidad variable.', 45.00, 60, 'Bosch', 'GSB 550', 'HE001', 2);

INSERT INTO producto (nombre, descripcion, precio, stock, marca, modelo, codigo, id_categoria)
VALUES ('Amoladora angular', 'Amoladora de 115mm, ideal para corte y pulido.', 60.00, 40, 'Makita', '9557HNG', 'HE002', 2);

-- Materiales de construcción
INSERT INTO producto (nombre, descripcion, precio, stock, marca, modelo, codigo, id_categoria)
VALUES ('Cemento Portland', 'Bolsa de cemento de 42.5 kg.', 7.00, 200, 'Holcim', 'CEM42', 'MC001', 3);

INSERT INTO producto (nombre, descripcion, precio, stock, marca, modelo, codigo, id_categoria)
VALUES ('Ladrillo rojo', 'Ladrillo macizo de arcilla.', 0.25, 1000, 'Ladrillera Nacional', 'LR100', 'MC002', 3);

-- Pinturas y acabados
INSERT INTO producto (nombre, descripcion, precio, stock, marca, modelo, codigo, id_categoria)
VALUES ('Pintura blanca interior', 'Pintura látex blanca para interiores, 4L.', 15.00, 80, 'Sherwin Williams', 'Interior Blanco', 'PA001', 4);

INSERT INTO producto (nombre, descripcion, precio, stock, marca, modelo, codigo, id_categoria)
VALUES ('Rodillo de pintura', 'Rodillo de microfibra para acabados finos.', 4.50, 120, 'Truper', 'ROD-9MF', 'PA002', 4);

-- Fontanería
INSERT INTO producto (nombre, descripcion, precio, stock, marca, modelo, codigo, id_categoria)
VALUES ('Tubería PVC 1"', 'Tubo de PVC para agua fría, 3 metros.', 2.75, 300, 'Tigre', 'PVC100', 'FO001', 5);

INSERT INTO producto (nombre, descripcion, precio, stock, marca, modelo, codigo, id_categoria)
VALUES ('Llave de paso', 'Llave de paso metálica de 1/2 pulgada.', 5.80, 200, 'Ferroval', 'LVP12', 'FO002', 5);
